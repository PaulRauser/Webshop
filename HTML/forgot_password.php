...
if (isset($_POST['usermail'])) {
  try {
    ...
    if ((int)($rowCount["c"]) == 0) {
      ...
      $sqlGetLastName = "SELECT last_name FROM user WHERE email=?";
      $t2 = $conn->prepare($sqlGetLastName);
      $t2->execute([$sCheckedMail]);
      ...
      $_SESSION['forgot_password_email'] = $sCheckedMail;
      header("Location: reset_password_mail.php");
    }
